...
Puis, avec l'instruction JavaScript `filter`, on crée un tableau contenant uniquement l'année séléctionnée et on effectue une jointure entre les données et le fond de carte grâce à la bibliothèque `bertin` (*on peut aussi télécharger la bibliothèque [ici](https://cdn.jsdelivr.net/npm/bertin@1.6)*).
