...
Dans ce TP, nous privilégions l'utilisation du logiciel **Rstudio**. Pour le télécharger et l'installer, clickez sur ce [lien](https://posit.co/download/rstudio-desktop/).
...
- Dans le repertoire **TP1**, créez également un sous répértoire **data** pour mettre les données et eventuellement un repertoire **lib** pour un stocker les bibliothèques JavaScript que nous allons utiliser. 
...
*Nb : pour travailler offline, vous pouvez aussi télécharger la librairie bertin [ici](https://cdn.jsdelivr.net/npm/bertin@1.6.2) et indiquer son emplacement. Par exemple si vous le mettez dans le repertoire __lib__ : *
...
Trois paramètres sont absolement nécéssaires à l'affichage de la couche cercles proportinnels : 

- `type` : le type de représentation (ici `bubble`)
- `geojson` : l'objet geoJSON contenant les géométries et les données atributaires.
...
Dans `bertin`, il s'agit donc de faire varier la propriété `fill` et de la faire varier en fonction d'une donnée qualitative. Pour cela, on utilise le type `typo` <a href="https://github.com/neocarto/bertin#typology"><img src="img/logo_doc.png"/></a><a href="https://observablehq.com/@neocartocnrs/bertin-js-typo?collection=@neocartocnrs/bertin"><img src="img/logo_exemple.png"/></a> à l'interieur de la propriété `fill`.
...
Reprenons le cas de de la carte par symboles proportionnels de tout à l'heure et redons-là interactive avec des `Inputs` <a href="https://github.com/observablehq/inputs"><img src="img/logo_doc.png"/></a> <a href="https://observablehq.com/@observablehq/inputs"><img src="img/logo_exemple.png"/></a>
...
Il est également possible d'ajouter des infobulles grace à la propriété `tooltip` <a href="https://observablehq.com/@neocartocnrs/bertin-js-tooltips?collection=@neocartocnrs/bertin"><img src="img/logo_exemple.png"/></a>
