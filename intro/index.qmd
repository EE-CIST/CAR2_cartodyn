...
::: {.notes}
Cette introduction pose des éléments de contexte sur l'histoire de la dataviz et les évolutions technologiques récentes. Pour en savoir plus : https://observablehq.com/@tophtucker/classic-research-in-data-visualization
:::
...
::: {.notes}
Puis, intervient la révolution numérique. De nouvelles technologies mais qui ne remettent pas fondamentalement en causes la théorie de la sémiologie graphique. 
:::
...
::: {.notes}
Nous allons parler à présent du langage JavaScript.
Points clés : c'ets un vieux langage qui n'a pas été concu pour l'analyse de données. Mais c'ets le langage du web. Il fonctionne sur tous les navigateurs web sans avoir besoin d'installer quoi que ce soit. Ce langage peut être étendu pour devenir un langage dédié à la dataviz. 
:::
...
::: {.notes}
La bibliothèque bertin est une bibliotheque de cartographie pour le web. Voir : https://github.com/neocarto/bertin
:::
...
Lien de téléchargement : [https://cdn.jsdelivr.net/npm/bertin\@latest](https://cdn.jsdelivr.net/npm/bertin@latest)
...
*(Pour travailler sans connexion, on peut aussi la télécharger ici : [https://cdn.jsdelivr.net/npm/geotoolbox\@latest](https://cdn.jsdelivr.net/npm/geotoolbox@latest))*
