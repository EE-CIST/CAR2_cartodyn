...
Avec D3, il est possible de dessiner e, JavaScript des images vectorielles au format CANVAS et SVG en manipulant le DOM.
...
On charge la bibliothèque avec l'instruction `require` en indiquant le numéro de version ou en prenant la derbiere version.
